          ...
          >
            ...
            {/* <div className="p-6 flex flex-col flex-1 justify-between">
              <div>
                ...
                <p className="text-xs font-geist mb-4">{s.tagline}</p>
              ...
              <div className="flex justify-between items-center w-full">
                <div className="flex items-center gap-2">
                  <Avatar className="size-10">
                    <AvatarImage src={""} />
                    <AvatarFallback>{s.creator?.[0]}</AvatarFallback>
                  </Avatar>
                ...
                <Button
                  size={"sm"}
                  className="float-right  font-geist bg-rose-600 hover:bg-rose-600 text-white "
                >
...
const showcases = [
  ...
  },
  {
    ...
    tagline:
      "Wield ancient light against creeping shadows in a world reborn from myth.",
    engine: "Unity",
    genre: ["Puzzle", "Action", "Sci-fi"],
    status: "Launched",
    creator: " @DimensionXDev",
